   ...
   <div class="w3-col l3 s6">
      <div class="w3-container" style="padding-top: 100px;">
        <div class="w3-display-container">
          <img src="./upload/${productNewList.image_main_file }" onError="this.onerror=null; this.src='resources/images/noImg.JPG';"  alt="..." style="width: 100%">
	...
	<div class="paging">
        <c:choose>
			<c:when test="${param.pageNum > 1}">
				<a href="New.ma?pageNum=${param.pageNum - 1 }">이전</a>
			</c:when>
			<c:otherwise>
		...
		<c:choose>
			<c:when test="${param.pageNum < pageInfo.maxPage}">
				<a href="New.ma?pageNum=${param.pageNum + 1 }">다음</a>
			</c:when>
			<c:otherwise>
