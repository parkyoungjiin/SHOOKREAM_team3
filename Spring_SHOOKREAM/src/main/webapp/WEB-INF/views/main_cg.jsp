  ...
  <input type="hidden" id="product_idx${status.index }" value="${productList.product_idx }">
   <div class="w3-col l3 s6">
        ...
        <div class="w3-display-container">
          <img src="${path}/resources/upload/${productList.image_main_file }"  onError="this.onerror=null; this.src='resources/images/noImg.JPG';"  alt="..." style="width: 100%">
...
<%-- 									<button class="w3-button w3-black" onclick="location.href='ProductInfoForm.po?product_idx=${productList.product_idx }&member_idx=${sessionScope.member_idx }'"> --%>
									<button class="w3-button w3-black" onclick="location.href='ProductInfoForm.po?product_idx=${productList.product_idx }'">	
...
<%-- 								 	<input type="hidden" id="product_idx${status.index }" value="${productBestList.product_idx }"> --%>
									   <c:if test="${wish.product_idx eq productList.product_idx}">
							...
							<p id="product_brand" onclick="location.href='BrandCG.ma?cg=${productList.product_brand }'" style="cursor: pointer;">${productList.product_brand }</p>
							<p id="product_name" onclick="location.href='ProductInfoForm.po?product_idx=${productList.product_idx }'" style="cursor: pointer;">${productList.product_name }<br></p>
...
<%-- 									<c:out value="${discounted_price}" /> --%>
								...
								<c:otherwise>
									<span id="price"><fmt:formatNumber value="${productList.product_price }" pattern="#,###" /></span>
								</c:otherwise>
							</c:choose>
							</div>
