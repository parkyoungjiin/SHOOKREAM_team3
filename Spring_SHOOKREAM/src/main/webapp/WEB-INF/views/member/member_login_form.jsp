  ...
  <div class="w3-padding-64 w3-small w3-center" >
    <div id = "sform">
        ...
        <form action="LoginMemberPro.me" method="post">
          <table>
          <tr>
          <td width="400px"><input class="w3-input w3-border" type="text" placeholder="아이디" name="member_id" required></td>
          </tr>
          <tr>
          <td width="400px"><input class="w3-input w3-border" type="password" placeholder="비밀번호" name="member_pass" required></td>
          </tr>
          <tr>
